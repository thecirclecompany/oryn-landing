  ...
  return (
    <div className="flex min-h-screen items-center justify-center relative bg-black">
      ...
      <svg
        ...
        className="h-14 absolute mx-auto top-12"
      >
        <path
      ...
      <div className="relative flex flex-col items-center text-center gap-6 px-6 z-50">
        <div className="space-y-8 max-w-2xl">
          <h1 className="text-4xl md:text-6xl leading-[100%] font-semibold text-white">
            One Bridge.
            <br /> Every Avalanche L1.
          </h1>
          <p className="text-sm uppercase text-[#9CE5FF] font-semibold leading-[180%]">
        ...
        <div className="w-full flex flex-col items-center gap-4 max-w-xl">
          ...
          {timeLeft?.complete && (
            <p className="text-sm text-[#C7FF6F]">
        ...
        <form className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-xl">
          ...
          <input
            ...
            className="w-full rounded-full bg-white/10 border border-white/20 text-white placeholder-white/60 px-6 py-3 focus:outline-none focus:ring-2 focus:ring-[#9CE5FF]/80 transition"
          />
          <button
            type="submit"
